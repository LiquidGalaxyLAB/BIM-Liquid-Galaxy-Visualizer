...
import 'package:bim_visualizer_flutter/presentation/widgets/loading.dart';
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          return BlocProvider(
            ...
            child: BlocConsumer<GalaxyBloc, GalaxyState>(
              ...
              builder: (context, state) {
                if (state is GalaxyExecuteInProgress) {
                                      ...
                                      actions: <Widget>[
                                        ...
                                        TextButton(
                                          ...
                                          onPressed: () {
                                            ...
                                            _galaxyBloc.add(GalaxyExecute(client!, command, true, false));
                                            Navigator.of(context).pop();
                                          }
                                        )
                                      ]
